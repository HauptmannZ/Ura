                    ...
                    <div class="card bg-secondary border-0">
                        <div class="card-body px-lg-5 py-lg-5">
                            <div class="text-center text-muted mb-4">
                                <div class="container">
                                    <div class="header-body text-center mb-7">
                                        <div class="row justify-content-center">
                                            <div class="col px-5">
                                                <h1 class="text-dark">Ubah Password</h1>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <form action="/updatePassword" method="POST">
                                @csrf
                                <input class="form-control @error('email') is-invalid @enderror" placeholder="Email" id="id"
                                    name="id" type="hidden" value="{{ $id }}" readonly>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary mt-4">Simpan Password</button>
                                </div>
                            </form>
                        </div>
                    </div>
